...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'update-info',
        loadChildren: () => import('./pages/update-info/update-info.module').then(m => m.UpdateInfoModule)
      },
      {
        path: 'friend/:level',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'accept-invite/:invitorId', component: AcceptInviteComponent, data: { title: 'Accept Invitation' } },
